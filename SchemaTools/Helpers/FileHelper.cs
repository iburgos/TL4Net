...
namespace Telegram4Net.SchemaTools.Helpers
{
    ...
    {
        public const string DomainFolder = "Domain\\TL\\AutoGenerated";

        public static void CleanFolder()
        {
            string directoryName = $"{RootFolder}\\{DomainFolder}";
        ...
        public static string GetFolderName(string type)
        {
            ...
            return domain == string.Empty ? $"{RootFolder}\\{DomainFolder}" : $"{RootFolder}\\{DomainFolder}\\{NameHelper.Capitalize(domain)}";
        }
